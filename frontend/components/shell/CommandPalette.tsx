  ...
  return (
    <>
      <button
        ...
        className="flex w-full items-center gap-2 rounded-full border border-hairline bg-elevated py-1.5 pr-1.5 pl-3.5 text-sm text-ink-faint transition-colors duration-150 hover:border-edge hover:text-ink-muted focus-visible:border-brand focus-visible:ring-3 focus-visible:ring-brand/25 focus-visible:outline-none"
      >
        ...
        <kbd className="rounded-full border border-hairline bg-subtle px-2 py-0.5 font-mono text-[10px] text-ink-faint">
          ⌘K
        </kbd>
      </button>
